...
var userGroup = '((?:[a-z0-9]{1,2}|[a-z0-9][a-z0-9-]{1,38}))'
var projectGroup = '((?:[_A-Za-z0-9-]|\\.git[_A-Za-z0-9-]|\\.(?!git))+)'
var repoGroup = userGroup + '\\/' + projectGroup

// Match a repo from a Git / GitHub URL.
var repositoryExpression = new RegExp(
  '(?:^|/(?:repos/)?)' + repoGroup + '(?=\\.git|[\\/#@]|$)',
  'i'
)
...
function github(options) {
  ...
  repository = repositoryExpression.exec(repository)

  repositoryExpression.lastIndex = 0
